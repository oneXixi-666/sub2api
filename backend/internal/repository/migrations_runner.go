...
var migrationChecksumCompatibilityRules = map[string]migrationChecksumCompatibilityRule{
	...
	// v0.1.193 changed the published upstream 225 migration in place. Keep the
	// upstream file unchanged while accepting only that release's known checksum.
	"225_backfill_codex_fingerprint_seed.sql": newStrictMigrationChecksumCompatibilityRule("bd8d6dff505e417eee69a2da300aa1df06e832fd668c7848f06944c7c0c3fd26", "ccce6f9cd2e5c692bd764ef2474792107a36e7f1a75043c60603253eaff32c3e"),
...
func newStrictMigrationChecksumCompatibilityRule(fileChecksum string, acceptedDBChecksums ...string) migrationChecksumCompatibilityRule {
	rule := newMigrationChecksumCompatibilityRule(fileChecksum, acceptedDBChecksums...)
	rule.strictFileChecksum = true
	return rule
}
