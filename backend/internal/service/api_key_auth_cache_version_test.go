...
func TestAPIKeyService_RejectsV19AuthSnapshotWithoutGroupPricing(t *testing.T) {
	svc := &APIKeyService{}
	...
	if ok {
		t.Fatal("expected v19 auth snapshot to be rejected after group pricing fields were added")
	}
	if apiKey != nil {
