export default {
  ...
  // Auth
  auth: {
    platformSubtitle: 'AI API 管理与用量工作台',
    promoTickerAccess: '一个入口，少开几个标签页',
    promoTickerKeys: 'Key 排好队，谁也别失联',
    promoTickerUsage: '请求有迹可循，Token 去向可查',
    promoTickerTheme: '深色偏好记着，不让眼睛加班',
    promoEyebrow: 'AI API 管理工作台',
    promoHeadlineAccess: '一个工作台',
    promoHeadlineControl: '管好每一次调用',
    promoDescription: '密钥、余额、用量与请求记录集中管理。日常查看更清楚，遇到问题也有据可查。',
    promoReceiptTitle: '登录后解锁',
    promoReceiptKeys: 'API KEY',
    promoReceiptRequests: '请求记录',
    promoReceiptUsage: '用量统计',
    promoReceiptBilling: '余额与账单',
    promoReceiptManage: '整整齐齐',
    promoReceiptVisible: '有迹可循',
    promoReceiptTrack: '花哪儿明白',
    promoReceiptClear: '不搞神秘',
    promoReceiptFooter: '进去看看 Token 都忙啥了',
    secureEntry: '正经登录，不整花活',
    showPassword: '显示密码',
    hidePassword: '隐藏密码',
    rightsReserved: '保留所有权利。',
    welcomeBack: '欢迎回来',
    signInToAccount: '登录后继续管理你的 API 服务与账户。',
    signIn: '登录',
    signingIn: '登录中...',
    ...
    promoCodeValid: '有效！注册后将获得 {symbol}{amount} 赠送余额',
