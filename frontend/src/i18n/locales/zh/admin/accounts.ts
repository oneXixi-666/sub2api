export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: '多人共享同一 OAuth 账号时，将各用户的设备/会话标识收敛为账号级恒定值，减少上游可见的设备数和会话数。默认使用 session 收敛；如需完全原样透传客户端标识，请显式选择关闭。',
        ...
        codexTicketLogs: {
          ...
          reasons: {
            ...
            degraded_length: '业务响应返回降级门票长度，已作废当前门票并等待重新打票',
            model_mismatch: '业务完成事件的模型与打票模型不一致，已作废当前门票并等待重新打票',
