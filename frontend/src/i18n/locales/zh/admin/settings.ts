export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        codexTicketEnabled: 'Codex 门票（个人 292 / Team·Business 332）',
        codexTicketEnabledDesc:
          '关闭后不打票、不注入 x-codex-turn-state，按原链路转发。开启后后台打 Codex 门票：个人首选 292，Team/Business 首选 332；这两种长度都算有效票，降级长度仍会丢弃。',
      ...
      site: {
        ...
        displayLocalesTitle: '显示语言包',
        displayLocalesDescription: '选择语言切换器中出现的语言包，至少保留一种语言。',
        displayLocalesHint: '用户会继续使用当前语言；若该语言被关闭，则回退到默认语言。',
        defaultLocale: '默认语言',
        defaultLocaleHint: '浏览器语言或本地缓存不在已启用列表中时使用。',
        displayCurrency: '显示货币代码',
        displayCurrencyPlaceholder: 'CNY',
        displayCurrencyHint:
          '用于余额、用量和入账金额展示的 ISO 4217 三字母代码。不会改变支付渠道自身的结算货币。',
        displayCurrencySymbol: '货币符号',
        displayCurrencySymbolHint: '显示在金额前面。留空则按货币代码自动推导（例如 CNY → ¥）。',
        displayCurrencyPreview: '预览',
        displayLocalesRequired: '至少保留一个语言包',
        displayCurrencyFormatError: '货币代码必须是三个字母（例如 CNY 或 USD）'
      },
      purchase: {
        title: '充值/订阅页面',
      ...
      customMenu: {
        ...
        nameTranslationsHint: '某语言留空时使用默认名称。',
        url: '页面 URL',
