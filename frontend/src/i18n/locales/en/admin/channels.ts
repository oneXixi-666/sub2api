export default {
    ...
    riskControl: {
      ...
      cyberPolicyExcludeBanHint: 'When enabled, enforced cyber_policy hits no longer count toward auto-ban. Evidence and enforcement notices remain available. Collect-only groups never count or receive notices.',
      ...
      cyberEvidenceTitle: 'cyber_policy conversation evidence',
      cyberEvidenceHint: 'Captured for later review; it does not identify the provider classifier\'s exact trigger.',
      evidenceProtocol: 'Protocol',
      evidenceStage: 'Request stage',
      evidenceSize: 'Captured size',
      evidenceSizeValue: '{chars} characters / {messages} text segments',
      evidenceHash: 'Normalized input hash',
      evidenceTruncated: 'Content truncated',
      ...
      groupScopeHint: 'Controls proactive content moderation and does not limit cyber_policy evidence collection.',
      hardBlockGroupScope: 'Hard-block groups',
      hardBlockGroupScopeHint: 'Only these groups may be rejected by local keyword or hash rules; other groups can still be observed.',
      userObservationGroupScope: 'User-input observation groups',
      userObservationGroupScopeHint: 'Controls keyword observation and moderation API checks for real user input.',
      contextObservationGroupScope: 'Context observation groups',
      contextObservationGroupScopeHint: 'Controls keyword observation for assistant, tool, and environment content.',
      cyberEnforcementScope: 'cyber_policy enforcement groups',
      cyberEnforcementScopeHint: 'Matched groups receive follow-up session blocking, violation counting, and enforcement notices. Other groups only collect review evidence.',
      cyberEnforcementBoundary: 'Group scope controls local follow-up action only. A current request already rejected upstream with cyber_policy cannot be restored by the gateway.',
      cyberPolicyEnforceMode: 'Enforced',
      cyberPolicyCollectMode: 'Collect only',
      cyberPolicyCollectDescription: 'Keep conversation evidence and the upstream error only. Do not block the session, count a violation, send a notice, or ban the account.',
      cyberDefaultPolicy: 'Default Cyber Policy',
      cyberDefaultPolicyHint: 'Groups without an override inherit this policy. Evidence is always collected; the policy controls follow-up actions only.',
      cyberPolicyInheritedBy: '{count} groups inherit this policy',
      cyberGroupPolicies: 'Group Policy Overrides',
      cyberGroupPoliciesHint: 'Create a complete independent policy for groups that need different enforcement. Removing it restores inheritance.',
      cyberSelectGroup: 'Select a group to configure',
      cyberNoGroupsToAdd: 'Every group is configured',
      cyberAddGroupPolicy: 'Add policy',
      cyberNoGroupPolicies: 'No group policy overrides',
      cyberNoGroupPoliciesHint: 'Every group currently uses the default Cyber policy.',
      cyberGroupOverrideHint: 'This policy fully replaces the default Cyber policy',
      cyberRemoveGroupPolicy: 'Remove group policy',
      cyberUnknownGroup: 'Unknown group #{id}',
      cyberCollectionInvariant: 'Every official cyber_policy hit is retained for review regardless of proactive audit group or model filters. Collection stops only when the Risk Control master switch is off.',
      cyberSessionBlock: 'Session block',
      cyberSessionBlockShortHint: 'Stop this session from continuing',
      cyberSessionBlockTTL: 'Session block TTL (seconds)',
      cyberSessionBlockMasterHint: 'The global Cyber session-block switch in System Settings must also be enabled.',
      cyberViolationCount: 'Count violations',
      cyberViolationCountHint: 'Count by account and current group',
      cyberEmailNotice: 'Hit notification',
      cyberEmailNoticeHint: 'Email on every hit',
      cyberAutoBanAccount: 'Auto-ban account',
      cyberAutoBanAccountHint: 'Disable the entire user account and invalidate its auth cache at this group threshold',
      cyberGroupCounterHint: 'Cyber counts do not accumulate across groups. An account ban still affects the whole account.',
      cyberPolicySnapshotTitle: 'Effective policy at time of hit',
      cyberPolicySnapshotHint: 'This snapshot preserves the original enforcement basis when configuration changes later.',
      cyberPolicySourceDefault: 'Inherited default policy',
      cyberPolicySourceGroup: 'Group override policy',
      selectedGroups: 'Selected Groups',
      selectedGroupCount: '{count} groups selected',
      searchGroups: 'Search group name or platform',
      noGroups: 'No groups available',
      modelFilter: 'Model scope',
      modelFilterHint: 'Apply proactive content moderation by the client-requested model name. This does not limit official cyber_policy evidence collection.',
      ...
      tabs: {
        ...
        response: 'Hit Notice',
        riskThresholds: 'Risk Thresholds',
        keywords: 'Keyword Policy',
        retention: 'Retention',
      },
      blockedKeywords: 'User-input observation terms',
      blockedKeywordsPlaceholder: 'One observation term per line for current user input',
      blockedKeywordsDescription: 'Scans only the current attributable user input and unroled input. Hits are not flagged, counted, emailed, or used for bans.',
      contextObservationKeywords: 'Context observation terms',
      contextObservationKeywordsPlaceholder: 'One tool/model-output observation term per line; keep this list small',
      contextObservationKeywordsDescription: 'Scans assistant, tool, and complete environment envelopes, but not fixed system/developer prompts. Hits are observation-only.',
      blockedKeywordsPreBlockHint: 'Broad terms are observation-only. Only high-confidence terms and upstream moderation results can block requests.',
      blockedKeywordsModeWarning: 'Current mode is "{mode}". Observation terms remain non-blocking and high-confidence terms do not locally block.',
      blockedKeywordCount: '{count} observation terms',
      hardBlockedKeywords: 'High-confidence block terms',
      hardBlockedKeywordsPlaceholder: 'One explicit intent phrase per line; keep this list small and precise',
      hardBlockedKeywordsDescription: 'Matched only against attributable current user input. Tool, system, environment, approval, and opaque Responses string content never hard-block.',
      hardBlockedKeywordCount: '{count} blocking terms',
      ...
      keywordModeKeywordAndApiDesc: 'Block on a high-confidence term; otherwise fall through to the upstream moderation API.',
      keywordModeKeywordOnly: 'Keyword only',
      keywordModeKeywordOnlyDesc: 'Attributable user input uses high-confidence terms only; Responses strings and unroled input still go to the moderation API.',
      keywordModeKeywordOnlyNotice: 'Keyword-only strategy; unattributed Responses input still calls the moderation API.',
      keywordModeApiOnly: 'API only',
      keywordModeApiOnlyDesc: 'Use the upstream moderation API only. Observation terms still log; high-confidence terms do not block.',
      keywordModeApiOnlyNotice: 'API-only strategy: high-confidence terms do not block and requests are decided by the upstream moderation API.',
      overview: {
        status: 'Status',
        enabled: 'Enabled',
        disabled: 'Disabled',
      ...
      result: {
        ...
        hit: 'Hit',
        blocked: 'Blocked',
        observe: 'Keyword observed',
        pass: 'Pass',
        error: 'Error',
      },
      action: {
        block: 'Blocked',
        keywordObserve: 'Keyword Observed',
