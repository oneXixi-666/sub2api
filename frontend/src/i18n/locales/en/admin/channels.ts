export default {
    ...
    riskControl: {
      ...
      blockedKeywords: 'Observation keywords (broad)',
      blockedKeywordsPlaceholder: 'One observation term per line; the existing broad list can remain here',
      blockedKeywordsDescription: 'Matching is case-insensitive. Hits are observation events only and never block, count as violations, send email, or ban users.',
      ...
      keywordModeKeywordOnlyDesc: 'Use high-confidence terms only; misses are allowed without calling the upstream API.',
      keywordModeKeywordOnlyNotice: 'Keyword-only strategy: requests that do not match a high-confidence term are allowed.',
