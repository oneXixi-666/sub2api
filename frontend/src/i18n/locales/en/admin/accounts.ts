export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: 'When multiple users share the same OAuth account, converge device/session identifiers to account-level stable values to reduce upstream-visible device and session count. Session convergence is enabled by default; choose Off to pass client identifiers through unchanged.',
        ...
        codexTicketLogs: {
          ...
          reasons: {
            ...
            degraded_length: 'Production response returned a degraded ticket length; the current ticket was invalidated and will be harvested again',
            model_mismatch: 'The completed response model did not match the harvested model; the current ticket was invalidated and will be harvested again',
