export default {
  ...
  // Auth
  auth: {
    platformSubtitle: 'AI API management and usage workspace',
    promoTickerAccess: 'One login, fewer tabs to babysit',
    promoTickerKeys: 'Keys lined up, nobody goes missing',
    promoTickerUsage: 'Requests traced, tokens accounted for',
    promoTickerTheme: 'Dark mode remembered. Your eyes are welcome.',
    promoEyebrow: 'AI API management workspace',
    promoHeadlineAccess: 'One workspace',
    promoHeadlineControl: 'for every API call',
    promoDescription: 'Manage keys, balance, usage, and request history in one place. Stay organized and trace issues with confidence.',
    promoReceiptTitle: 'Unlocked after sign-in',
    promoReceiptKeys: 'API KEY',
    promoReceiptRequests: 'REQUESTS',
    promoReceiptUsage: 'USAGE',
    promoReceiptBilling: 'BALANCE & BILLING',
    promoReceiptManage: 'LINED UP',
    promoReceiptVisible: 'TRACEABLE',
    promoReceiptTrack: 'ACCOUNTED FOR',
    promoReceiptClear: 'NO MYSTERIES',
    promoReceiptFooter: 'See what your tokens have been up to',
    secureEntry: 'No-drama sign-in',
    showPassword: 'Show password',
    hidePassword: 'Hide password',
    rightsReserved: 'All rights reserved.',
    welcomeBack: 'Welcome back',
    signInToAccount: 'Sign in to continue managing your API services and account.',
    signIn: 'Sign In',
    ...
    promoCodeValid: 'Valid! You will receive {symbol}{amount} bonus balance',
