<template>
  <div class="card">
    ...
    <div class="space-y-3 p-4">
      <button @click="router.push('/keys')" class="dashboard-action group flex w-full items-center gap-4 p-4 text-left">
      ...
      <button @click="router.push('/usage')" class="dashboard-action group flex w-full items-center gap-4 p-4 text-left">
      ...
      <button v-if="canUseBatchImage" @click="router.push('/batch-image')" class="dashboard-action group flex w-full items-center gap-4 p-4 text-left">
      ...
      <button @click="router.push('/redeem')" class="dashboard-action group flex w-full items-center gap-4 p-4 text-left">
