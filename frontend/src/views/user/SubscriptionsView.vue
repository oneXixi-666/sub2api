<template>
  <AppLayout>
    <div class="promo-page-stack promo-subscription-shell space-y-6">
      <!-- Loading State -->
          ...
          <div class="space-y-4 p-4">
            ...
            <div v-if="subscription.group?.daily_limit_usd" class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm text-gray-500 dark:text-dark-400">
                  {{ billingDisplay.symbol }}{{ (subscription.daily_usage_usd || 0).toFixed(2) }} / {{ billingDisplay.symbol }}{{
            ...
            <div v-if="subscription.group?.weekly_limit_usd" class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm text-gray-500 dark:text-dark-400">
                  {{ billingDisplay.symbol }}{{ (subscription.weekly_usage_usd || 0).toFixed(2) }} / {{ billingDisplay.symbol }}{{
            ...
            <div v-if="subscription.group?.monthly_limit_usd" class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm text-gray-500 dark:text-dark-400">
                  {{ billingDisplay.symbol }}{{ (subscription.monthly_usage_usd || 0).toFixed(2) }} / {{ billingDisplay.symbol }}{{
