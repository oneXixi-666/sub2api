<template>
  <component :is="isPopup ? 'div' : AppLayout" :class="isPopup ? 'promo-payment-standalone min-h-screen' : ''">
    <div class="promo-page-stack promo-payment-receipt mx-auto max-w-lg space-y-6 py-8" :class="isPopup ? 'px-4' : ''">
