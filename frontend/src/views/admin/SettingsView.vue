    ...
    <div class="mx-auto max-w-6xl space-y-6">
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        ...
        <div v-show="activeTab === 'general'" class="space-y-6">
          ...
          <!-- Custom Menu Items -->
          <div class="card custom-menu-editor">
            <div
              class="border-b border-gray-100 px-6 py-4 dark:border-dark-700"
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
            ...
            <div class="custom-menu-editor-body space-y-4 p-6">
              <!-- Existing menu items -->
              <div
                v-for="(item, index) in form.custom_menu_items"
                :key="item.id || index"
                class="custom-menu-editor-item p-4"
              >
                <div class="mb-3 flex items-center justify-between">
                  <span
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    <button
                      v-if="index > 0"
                      type="button"
                      class="custom-menu-icon-button btn btn-ghost btn-icon"
                    ...
                    <button
                      type="button"
                      class="custom-menu-icon-button custom-menu-remove-button btn btn-ghost btn-icon"
              ...
              <button
                type="button"
                class="custom-menu-add-button flex w-full items-center justify-center gap-2 py-3 text-sm font-bold"
                @click="addMenuItem"
              >
